  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-white rounded-xl p-6 lg:p-8 shadow-sm border border-gray-100">
        ...
        <p className="text-sm text-gray-500 mb-6">Activitat única — Cada RA = 1/6 de la nota</p>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center p-6 bg-blue-50 rounded-xl">
            <div className="text-4xl font-bold text-blue-600 mb-2">50%</div>
            <div className="font-semibold text-gray-900">Documentació</div>
            <p className="text-sm text-gray-600 mt-2">Cas + Arquitectura + Pla</p>
          </div>
          <div className="text-center p-6 bg-green-50 rounded-xl">
            <div className="text-4xl font-bold text-green-600 mb-2">20%</div>
            <div className="font-semibold text-gray-900">Prototipat</div>
            <p className="text-sm text-gray-600 mt-2">Implementació funcional</p>
          </div>
          <div className="text-center p-6 bg-purple-50 rounded-xl">
            <div className="text-4xl font-bold text-purple-600 mb-2">30%</div>
            <div className="font-semibold text-gray-900">Presentació</div>
            <p className="text-sm text-gray-600 mt-2">Exposició oral i demostració</p>
          </div>
        </div>
      </div>
