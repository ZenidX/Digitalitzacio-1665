...
## Criteris d'Avaluació del Prototipat (20%)

| Criteri | Descripció |
|---------|------------|
| **Funcionalitat** *(RA2, RA3, RA4)* | El prototip funciona i demostra la viabilitat de la tecnologia proposada |
| **Alineació amb arquitectura** *(RA6)* | Reflecteix fidelment l'arquitectura proposada al document |
| **Ús de recursos gratuïts** *(RA3)* | Ús correcte i optimitzat de free tiers i eines gratuïtes |
| **Documentació tècnica** *(RA6)* | Instruccions clares, completes i reproduïbles |
| **Innovació i creativitat** *(RA2, RA4)* | Solució que aporta valor afegit més enllà dels requeriments mínims |
